...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="p-3 flex mob:flex-col m-auto max-w-6xl justify-between items-center">
          <div className="logo mob:border-b mob:border-b-gray-200 flex justify-center items-center">
            ...
            <div className="text flex flex-col justify-start items-start">
              ...
              <p className="text-xs"> Indian Institute of Information Technology Vadodara </p>
          ...
          <div className="links mob:py-3 flex justify-center items-center space-x-5">
            ...
            <Link href="https://www.linkedin.com/company/gdsciiitv/"><div className="cursor-pointer linkedin">
            ...
            <Link href="https://instagram.com/gdsc_iiitv/"><div className="cursor-pointer insta">
            ...
            <Link href="https://x.com/gdsc_iiitv/"><div className="cursor-pointer twitter">
            ...
            {/* <Link href="https://gdsc.medium.com/"><div className="cursor-pointer medium">
      ...
      <div className="  w-full p-2 text-center bg-gray-900 text-gray-300">Developed By <a href="https://github.com/adi-ray" className="text-orange-400">Aditya Ray</a> </div>
    </>
  )
}
